...
public class StarbucksApp {
	...
	public static void main(String[] args) {
		...
		do {
			...
			while (!userPay.equalsIgnoreCase("cash") || !userPay.equalsIgnoreCase("check")
					|| !userPay.equalsIgnoreCase("card"));
		...
		if (userChoice >= 1 && userChoice <= 8) {
			...
			if (milkOption.equals("y")) {
				...
				if (milkChoice >= 4 && milkChoice <= 6) {
					...
					System.out.println(milk.get(milkChoice - 1));
			...
			if (flavorChoice.equals("y")) {
				...
				System.out.println(flavor.get(flavorOption - 1));
			...
			if (toastedChoice.equals("y")) {
				...
				newFood.setIfToasted("toasted");

				System.out.println(newFood.getIfToasted());
